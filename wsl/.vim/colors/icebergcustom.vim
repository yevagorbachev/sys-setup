...
"
" File:       icebergcustom.vim
" Maintainer: cocopon <cocopon@me.com>
" Colors modified by yevagorbachev for personal use
...
let g:colors_name = 'icebergcustom'
...
if &background == 'light'
  ...
  hi LineNr ctermfg=31 guifg=#3f83a6
  hi CursorLineNr ctermfg=31 guifg=#3f83a6
  ...
  hi IncSearch ctermbg=216 ctermfg=234 guibg=#404060 guifg=#ffffff
  " hi IncSearch cterm=reverse ctermfg=NONE gui=reverse guifg=NONE term=reverse
  ...
  hi Search ctermbg=216 ctermfg=234 guibg=#404060 guifg=#ffffff
  ...
  hi Visual ctermbg=236 ctermfg=NONE guibg=#404060 guifg=NONE
  hi VisualNOS ctermbg=236 ctermfg=NONE guibg=#404060 guifg=NONE
